...
import kr.co.mz.mzdinterviewassignment.dto.response.ErrorResponse;
...
public class ApiControllerAdvice {
  ...
  public ResponseEntity<ErrorResponse> handleCannotDeleteProfileException(
      CannotDeleteProfileException e) {
